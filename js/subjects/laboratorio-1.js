  ...
  partials: [
    {
      ...
      blurb: 'Fundamentos de Java, IDEs, ejecución en la JVM, relaciones entre objetos y primeras decisiones de diseño.',
      questions: [
        {
          kind: 'tf',
          q: 'Una clase pública llamada AutoDeportivo debe guardarse en un archivo llamado AutoDeportivo.java, respetando mayúsculas y minúsculas.',
          a: true,
          explain: 'Java distingue mayúsculas de minúsculas y exige que el archivo de una clase pública tenga exactamente el mismo nombre que la clase, seguido de la extensión .java.',
        },
        {
          kind: 'mc',
          q: '¿Qué componente aporta las herramientas de desarrollo, incluido el compilador, además de involucrar al entorno de ejecución?',
          options: [
            'La JVM, porque administra la memoria del programa.',
            'El JRE, porque contiene todo lo necesario para desarrollar.',
            'El JDK, porque reúne herramientas de desarrollo y el entorno de ejecución.',
            'El ClassLoader, porque transforma el código fuente en bytecode.',
          ],
          correctIndex: 2,
          explain: 'El JDK es el kit de desarrollo: incluye herramientas como javac y javadoc e involucra al JRE y a la JVM. El JRE alcanza para ejecutar, no para desarrollar.',
        },
        {
          kind: 'mc',
          q: 'En Eclipse, ¿qué elemento agrupa vistas y editores para una forma de trabajo determinada, como Java?',
          options: [
            'El workspace.',
            'La perspectiva.',
            'El package.',
          ...
          correctIndex: 1,
          explain: 'Una perspectiva organiza vistas y editores según la tarea. El workspace es el directorio de trabajo; package y classpath pertenecen a la organización y búsqueda de clases.',
        },
        {
          kind: 'open',
          q: 'Explicá el recorrido de un programa Java desde el archivo fuente hasta su ejecución e indicá el papel de javac, el bytecode, el JRE, el JIT y la JVM.',
          model: 'Se espera: el código fuente se escribe en un archivo .java y javac lo compila a un archivo binario .class con bytecode, que no es código de máquina. Al ejecutar, el JRE aporta el entorno y las bibliotecas necesarias; la JVM carga, verifica y ejecuta el bytecode, y el JIT puede compilar a código de máquina nativo las partes que conviene optimizar. Como cada plataforma tiene su propia JVM, el mismo bytecode puede ejecutarse en sistemas distintos.',
        },
        {
          kind: 'tf',
          q: 'En programación declarativa se especifica el resultado buscado y el motor decide cómo obtenerlo, como ocurre con una consulta SQL.',
          a: true,
          explain: 'El paradigma declarativo describe qué estado o resultado se quiere, sin detallar el algoritmo paso a paso. SQL es el ejemplo del apunte: el motor decide cómo resolver la consulta.',
        },
        {
          kind: 'mc',
          q: '¿Qué valor contiene cada posición de un arreglo Persona[] recién creado, antes de asignar objetos?',
          options: [
            'Una Persona construida con valores por defecto.',
            'El número entero 0.',
            'Una referencia a la clase Object.',
            'El valor null.',
          ],
          correctIndex: 3,
          explain: 'Un arreglo de referencias guarda referencias a objetos. Al crearlo, cada posición tiene el valor por defecto de todo tipo referencia: null.',
        },
        {
          kind: 'mc',
          q: 'Una subclase declara ladrar(int volumen) y hereda ladrar() de su superclase. ¿Qué relación hay entre ambos métodos?',
          options: [
            'Son una sobrecarga porque cambia la lista de parámetros.',
            'Son una sobreescritura porque conservan el mismo nombre.',
            'Son métodos abstractos porque uno proviene de la superclase.',
            'Son métodos estáticos porque se resuelven al compilar.',
          ],
          correctIndex: 0,
          explain: 'La sobrecarga mantiene el nombre pero cambia tipo, cantidad u orden de parámetros. Para sobreescribir hay que conservar la firma del método heredado.',
        },
        {
          kind: 'open',
          q: 'Modelá conceptualmente la relación entre Auto y Motor: indicá cardinalidad, direccionalidad y si la tratarías como agregación o composición. Justificá cada decisión según el negocio elegido.',
          model: 'Se espera una respuesta coherente con los supuestos. Un modelo simple puede ser uno a uno y unidireccional desde Auto hacia Motor. La ordinalidad depende del dominio: si el motor existe y se reutiliza con independencia del auto, es agregación; si el modelo establece que nace y deja de existir con ese auto, es composición. Lo importante es no decidir solo por la frase “tiene un”, sino explicitar navegación, cantidad y ciclo de vida.',
        },
        {
          kind: 'mc',
          q: '¿Por qué una clase abstracta puede definir constructores aunque no se la pueda instanciar directamente?',
          options: [
            'Porque el constructor convierte automáticamente la clase en concreta.',
            'Porque así puede implementar herencia múltiple de clases.',
            'Porque sus subclases ejecutan esa inicialización y reutilizan el código común.',
            'Porque todo constructor abstracto debe ser sobrescrito sin cuerpo.',
          ],
          correctIndex: 2,
          explain: 'Cuando se instancia una subclase concreta también se ejecuta la cadena de constructores de sus superclases. La abstracta puede inicializar una sola vez los atributos comunes.',
        },
        {
          kind: 'open',
          q: 'Diseñá un personaje que pueda cambiar su forma de atacar durante la ejecución sin recrearse. Indicá clases, interfaz, atributo y operación de cambio, y explicá por qué preferís composición.',
          model: 'Se espera: una interfaz FormaDeAtacar con una operación atacar(); implementaciones como AtaqueConRayos y AtaqueConMisiles; Personaje conserva un atributo FormaDeAtacar, delega en él desde ejecutarAtaque() y ofrece setFormaDeAtacar(...). Cambiar el objeto colaborador modifica el comportamiento en runtime. La composición evita fijar una variante en una jerarquía y permite extender o reemplazar el comportamiento sin tocar Personaje.',
        },
      ],
    },
    {
      ...
      blurb: 'Lectura de código Java: tipos, control de flujo, arreglos, conversiones, herencia, binding y referencias compartidas.',
      questions: [
        {
          kind: 'mc',
          q: '¿Cuál de estas declaraciones usa correctamente los literales de caracteres y cadenas en Java?',
          options: [
            'char inicial = "J"; String nombre = \'Juan\';',
            'char inicial = \'J\'; String nombre = "Juan";',
            'char inicial = `J`; String nombre = `Juan`;',
            'char inicial = "J"; String nombre = "Juan";',
          ],
          correctIndex: 1,
          explain: 'Un char se escribe entre comillas simples y un String entre comillas dobles. Las otras combinaciones no respetan los tipos de literal de Java.',
        },
        {
          kind: 'tf',
          q: 'Un bloque do...while ejecuta su cuerpo al menos una vez porque evalúa la condición después de ejecutar las instrucciones.',
          a: true,
          explain: 'A diferencia de while, do...while comprueba la condición al final. Por eso la primera ejecución ocurre aun cuando la condición resulte falsa.',
        },
        {
          kind: 'open',
          q: 'Una clase Vehiculo define acelerar(int valor) y Auto la redefine con la misma firma, además de agregar acelerar(String modo). Explicá qué es sobreescritura, qué es sobrecarga y qué versión se ejecuta con Vehiculo v = new Auto(); v.acelerar(2).',
          model: 'Se espera: Auto.acelerar(int) sobreescribe el método heredado porque conserva nombre y firma. acelerar(String) lo sobrecarga porque cambia el tipo del parámetro. Con una referencia Vehiculo que apunta a un Auto, la llamada v.acelerar(2) es válida por la interfaz pública de Vehiculo y, mediante dynamic binding, durante la ejecución se selecciona la implementación de Auto para acelerar(int). La variante String no es accesible desde esa referencia si Vehiculo no la declara.',
        },
        {
          kind: 'mc',
          q: '¿Qué puede ocurrir al convertir explícitamente un long grande a int?',
          options: [
            'El compilador amplía automáticamente el int para conservar el valor.',
            'El valor puede perder información porque se pasa a un contenedor más chico.',
            'El resultado siempre es null porque int no admite conversiones.',
            'La conversión es imposible incluso escribiendo un cast explícito.',
          ],
          correctIndex: 1,
          explain: 'El cast permite la conversión hacia un tipo numérico más chico, pero no garantiza que el valor entre. Los bits que no caben pueden perderse y cambiar el resultado.',
        },
        {
          kind: 'mc',
          q: 'Antes de convertir una referencia Persona a Ejecutivo, ¿qué operador permite comprobar el tipo real del objeto durante la ejecución?',
          options: [
            'typeof',
            'extends',
            'instanceof',
          ...
          correctIndex: 2,
          explain: 'instanceof comprueba si la referencia almacena una instancia compatible con la clase indicada. Es un operador y permite evitar un downcast que termine en ClassCastException.',
        },
        {
          kind: 'tf',
          q: 'En Java, length es un atributo de los arreglos y se consulta sin paréntesis.',
          a: true,
          explain: 'Los arreglos exponen length como atributo. Escribir arreglo.length() intentaría invocar un método que no existe para obtener su tamaño.',
        },
        {
          kind: 'open',
          q: 'Proponé una jerarquía de animales que comparta estado y código, pero que permita dar ciertos comportamientos solo a especies puntuales. Indicá qué pondrías en una clase abstracta y qué pondrías en interfaces.',
          model: 'Se espera: una clase abstracta Animal puede guardar identificador, nombre o fecha de ingreso, inicializarlos en su constructor y ofrecer comportamiento común como comer(). Los contratos selectivos —por ejemplo Amamantable con amamantar() u Oviparo con ponerHuevos()— conviene expresarlos con interfaces e implementarlos solo en las especies correspondientes. Así se reutiliza estado y código sin contaminar toda la jerarquía con operaciones vacías.',
        },
        {
          kind: 'mc',
          q: '¿Cuál de estos casos se resuelve mediante dynamic binding?',
          options: [
            'Elegir entre dos métodos sobrecargados según sus parámetros al compilar.',
            'Buscar una clase importada dentro del classpath del proyecto.',
            'Reservar memoria para una referencia antes de crear el objeto.',
            'Elegir en ejecución la implementación sobreescrita según el objeto real.',
          ],
          correctIndex: 3,
          explain: 'El dynamic binding selecciona durante la ejecución la versión sobreescrita que corresponde al tipo real del objeto. La resolución de una sobrecarga ocurre en compilación.',
        },
        {
          kind: 'mc',
          q: '¿Cuál es la sentencia correcta para importar ClaseA, ubicada en paquete1.otroPaquete?',
          options: [
            'package paquete1.otroPaquete.ClaseA;',
            'import ClaseA from paquete1.otroPaquete;',
            'include paquete1/otroPaquete/ClaseA;',
            'import paquete1.otroPaquete.ClaseA;',
          ],
          correctIndex: 3,
          explain: 'La sentencia import usa el nombre calificado completo: paquete, subpaquete y clase separados por puntos, con punto y coma al final.',
        },
        {
          kind: 'open',
          q: 'Dos computadoras comparten la misma referencia a un DiscoRigido. Explicá qué se observa al modificar el disco desde una de ellas y contrastalo con crear dos discos distintos que tengan inicialmente los mismos datos.',
          model: 'Se espera: si ambas computadoras apuntan al mismo objeto DiscoRigido, cualquier cambio de estado realizado a través de una referencia se observa al acceder desde la otra, porque hay un único objeto compartido. Si cada computadora recibe un new DiscoRigido distinto, aunque ambos comiencen con datos iguales tienen identidades y estados independientes; modificar uno no afecta al otro.',
        },
      ],
    },
    {
      ...
      blurb: 'Modelado orientado a objetos: relaciones, herencia, polimorfismo, contratos, memoria de la JVM y paradigmas.',
      questions: [
        {
          kind: 'tf',
          q: 'La herencia expresa una relación ES-UN y la composición expresa una relación TIENE-UN.',
          a: true,
          explain: 'Una subclase debe poder considerarse una instancia de su superclase: ES-UN. En composición, un objeto mantiene y usa otro objeto: TIENE-UN.',
        },
        {
          kind: 'mc',
          q: 'Una empresa necesita consultar qué vehículo usa cada empleado y también quién tiene asignado un vehículo dado. ¿Qué direccionalidad corresponde?',
          options: [
            'Unidireccional desde Vehiculo hacia Empleado.',
            'Unidireccional desde Empleado hacia Vehiculo.',
            'Bidireccional entre Empleado y Vehiculo.',
            'Sin relación porque las consultas son independientes.',
          ],
          correctIndex: 2,
          explain: 'El negocio necesita navegar desde cualquiera de los dos extremos. Por eso cada lado debe permitir alcanzar al otro y la relación es bidireccional.',
        },
        {
          kind: 'mc',
          q: '¿Cuál de estos ejemplos representa mejor una composición según el apunte?',
          options: [
            'Una computadora usa un mouse que puede reemplazarse.',
            'Un auto recibe un motor existente para funcionar.',
            'Un empleado consulta un vehículo de la empresa.',
            'Un televisor crea y posee su pantalla como parte inseparable.',
          ],
          correctIndex: 3,
          explain: 'En composición la parte no tiene sentido sin el todo y la relación es fuerte. El televisor crea y posee su pantalla; mouse y motor se presentan como objetos utilizables con mayor independencia.',
        },
        {
          kind: 'open',
          q: 'Explicá por qué ubicar amamantar() en una superclase Oviparo rompe el modelo del zoo y cómo una interfaz permite modelar correctamente al ornitorrinco sin afectar al resto de las especies.',
          model: 'Se espera: si Oviparo declara amamantar(), todas las aves y demás ovíparos heredan una operación que no les corresponde, lo que obliga a implementaciones vacías o errores. Una interfaz Mamifero puede declarar amamantar() y ser implementada solo por las especies que lo hacen; Oviparo puede ser otra interfaz para ponerHuevos() y romperCascaron(). El ornitorrinco implementa ambas sin forzar herencia múltiple de clases ni contaminar otras especies.',
        },
        {
          kind: 'tf',
          q: 'Una clase abstracta puede no declarar ningún método abstracto y seguir siendo abstracta para impedir su instanciación directa.',
          a: true,
          explain: 'Tener un método abstracto obliga a declarar abstracta la clase, pero la implicación inversa no vale. Una clase puede ser abstracta y contener solo código concreto reutilizable.',
        },
        {
          kind: 'mc',
          q: 'Dado Empleado e = new Empleado(); Ejecutivo j = (Ejecutivo) e;, ¿qué sucede?',
          options: [
            'No compila porque Java prohíbe todo downcasting explícito.',
            'Compila, pero falla en ejecución porque el objeto real no es Ejecutivo.',
            'Compila y crea automáticamente un Ejecutivo con los datos del Empleado.',
            'Compila y j queda en null porque el cast no coincide.',
          ],
          correctIndex: 1,
          explain: 'El cast explícito convence al compilador, pero no cambia el objeto real. En ejecución se detecta que el Empleado no es Ejecutivo y se produce ClassCastException.',
        },
        {
          kind: 'mc',
          q: '¿Qué principio permite agregar nuevas formas de volar sin modificar las clases que ya usan ese comportamiento?',
          options: [
            'Encapsular lo que varía para que cambie independientemente del resto.',
            'Hacer públicos todos los atributos de las superclases.',
            'Duplicar la implementación en cada clase concreta.',
            'Programar siempre contra una clase concreta.',
          ],
          correctIndex: 0,
          explain: 'Separar y encapsular los aspectos variables permite extenderlos sin tocar las partes estables. Las formas de volar pueden crecer detrás de un contrato común.',
        },
        {
          kind: 'open',
          q: 'Rediseñá un sistema de armas donde algunos vehículos vuelan, otros no, y cada uno puede cambiar su ataque. Aplicá programación contra interfaces y composición, indicando las dependencias principales.',
          model: 'Se espera: definir interfaces FormaDeVolar y FormaDeAtacar con implementaciones concretas. SistemaArmas mantiene referencias de esos tipos y delega ejecutarVuelo() y ejecutarAtaque(); setters permiten reemplazar las estrategias durante la ejecución. Las clases concretas reciben o seleccionan colaboradores compatibles, sin heredar operaciones que no les corresponden. El código depende de contratos y no de implementaciones concretas.',
        },
        {
          kind: 'mc',
          q: '¿En qué área de memoria de la JVM se alojan normalmente los objetos creados durante la ejecución?',
          options: [
            'En el STACK.',
            'En el HEAP.',
            'En el área de CLASS.',
          ...
          correctIndex: 1,
          explain: 'El HEAP aloja los objetos creados durante la ejecución. El STACK administra la pila de llamadas, el área de CLASS conserva valores estáticos y el CLASSPATH es una ruta de búsqueda.',
        },
        {
          kind: 'open',
          q: 'Compará programación imperativa y declarativa. Para cada una, explicá qué se describe, cómo se llega al resultado y mencioná un ejemplo del material.',
          model: 'Se espera: en la programación imperativa se detalla cómo cambiar el estado mediante instrucciones ordenadas, estructuras de control y repetición; Java o C son ejemplos. En la declarativa se expresa el estado o resultado deseado y el motor decide el procedimiento; SQL y HTML son ejemplos del material. La diferencia central es describir el algoritmo frente a declarar qué se quiere obtener.',
        },
      ],
    },
    {
      ...
      blurb: 'Herramientas y práctica integrada: Eclipse, javac, jar, javadoc, control de flujo, conversiones y diseño con contratos.',
      questions: [
        {
          kind: 'mc',
          q: '¿Qué acción permite llevar un proyecto de Eclipse a otra computadora conservando su estructura?',
          options: [
            'Copiar únicamente los archivos .class del directorio bin.',
            'Exportar el proyecto y luego importarlo en el otro workspace.',
            'Mover la perspectiva Java al nuevo sistema operativo.',
            'Agregar el nombre del proyecto a la variable CLASSPATH global.',
          ],
          correctIndex: 1,
          explain: 'El flujo enseñado por el tutorial es exportar el proyecto desde un workspace e importarlo en el otro. Una perspectiva no contiene el proyecto y los .class solos pierden la fuente.',
        },
        {
          kind: 'tf',
          q: 'El comando javac genera bytecode a partir del código fuente y el comando java inicia la ejecución de la clase compilada.',
          a: true,
          explain: 'javac es el compilador que transforma .java en .class con bytecode. La herramienta java pone en marcha el entorno de ejecución para la clase indicada.',
        },
        {
          kind: 'open',
          q: 'Escribí en pseudocódigo Java un programa que recorra un arreglo de enteros, ignore los negativos con continue, acumule los positivos y corte con break al encontrar un cero. Explicá el valor final para {4, -2, 7, 0, 9}.',
          model: 'Se espera una solución equivalente a: int suma = 0; for (int valor : valores) { if (valor < 0) continue; if (valor == 0) break; suma += valor; }. Para {4, -2, 7, 0, 9}, suma vale 11: se suma 4, se ignora -2, se suma 7 y el cero corta el bucle antes de llegar a 9. También es válida una solución por índices que use valores.length.',
        },
        {
          kind: 'mc',
          q: '¿Qué herramienta genera documentación navegable a partir de comentarios y declaraciones del código fuente?',
          options: [
            'jar',
            'JConsole',
            'javadoc',
          ...
          correctIndex: 2,
          explain: 'javadoc recorre el código fuente y genera el sitio de documentación. jar empaqueta archivos y JConsole permite observar aspectos de rendimiento de un proceso Java.',
        },
        {
          kind: 'mc',
          q: 'En la expresión byte resultado = unByte + otroByte;, ¿por qué suele hacer falta un cast explícito?',
          options: [
            'Porque toda suma numérica se convierte primero a double.',
            'Porque, si no interviene un tipo mayor, los operandos se promocionan a int.',
            'Porque byte solo puede usarse dentro de un arreglo.',
            'Porque el operador + concatena siempre cadenas en Java.',
          ],
          correctIndex: 1,
          explain: 'Las reglas de promoción llevan ambos operandos a int cuando no participa double, float o long. El resultado es int y debe castearse si se lo quiere guardar en byte.',
        },
        {
          kind: 'tf',
          q: 'Programar contra una interfaz obliga a que la variable del lado izquierdo tenga el tipo de una implementación concreta.',
          a: false,
          explain: 'Es al revés: la referencia del lado izquierdo usa el tipo del contrato y el objeto concreto queda del lado derecho. Así el cliente no depende de una implementación particular.',
        },
        {
          kind: 'open',
          q: 'Diseñá una clase abstracta Empleado con datos comunes y cálculo de sueldo obligatorio, más dos subclases concretas. Mostrá cómo un arreglo Empleado[] permite recorrerlas polimórficamente.',
          model: 'Se espera: Empleado puede guardar nombre y sueldoBase, inicializados en un constructor, y declarar un método abstracto calcularSueldo(). Dos clases como EmpleadoFijo y EmpleadoComision implementan el cálculo con sus reglas. Un Empleado[] puede guardar objetos de ambas subclases; al recorrerlo e invocar calcularSueldo(), el dynamic binding elige la implementación del objeto real sin condicionales por tipo.',
        },
        {
          kind: 'mc',
          q: '¿Cuál es la responsabilidad principal del Garbage Collector dentro de la ejecución Java?',
          options: [
            'Resolver imports buscando clases en todos los packages.',
            'Traducir el archivo fuente directamente a código de máquina.',
            'Empaquetar clases y recursos en un único archivo distribuible.',
            'Recuperar automáticamente memoria de objetos que ya no se usan.',
          ],
          correctIndex: 3,
          explain: 'El Garbage Collector administra y libera memoria de objetos que dejaron de ser alcanzables. No compila, empaqueta ni resuelve la organización de clases.',
        },
        {
          kind: 'mc',
          q: 'Si una subclase necesita reutilizar la implementación heredada de un método que está sobreescribiendo, ¿qué construcción corresponde?',
          options: [
            'this.metodo()',
            'static.metodo()',
            'super.metodo()',
          ...
          correctIndex: 2,
          explain: 'super.metodo() invoca la versión inmediata de la superclase. this.metodo() volvería a entrar en la versión actual y podría provocar recursión infinita.',
        },
        {
          kind: 'open',
          q: 'Explicá los tres principios de diseño trabajados hasta S40 y aplicalos a un comportamiento de vuelo que cambia entre vehículos.',
          model: 'Se espera: (1) identificar y encapsular lo que varía para que cambie independientemente de lo estable; (2) programar contra interfaces y no contra implementaciones concretas; (3) favorecer la composición por sobre la herencia. Para el vuelo, se extrae una interfaz FormaDeVolar, se crean implementaciones y el vehículo conserva una referencia a ese contrato, delega la acción y puede reemplazar el colaborador sin alterar su jerarquía.',
        },
      ],
    },
    {
      ...
      blurb: 'Simulacro integrador del primer parcial: código, ejecución, relaciones, jerarquías, interfaces y composición por sobre la herencia.',
      questions: [
        {
          kind: 'tf',
          q: 'Una referencia de tipo Persona puede apuntar a un objeto Ejecutivo porque Ejecutivo cumple la relación ES-UN con Persona.',
          a: true,
          explain: 'La asignación hacia arriba es válida e implícita: toda instancia de Ejecutivo también es una Persona. La referencia solo expone la interfaz pública declarada en Persona.',
        },
        {
          kind: 'mc',
          q: '¿Qué resultado describe mejor Persona p = new Ejecutivo(); seguido de p.trabajar(), si Ejecutivo sobreescribe trabajar()?',
          options: [
            'No compila porque referencia y objeto deben tener el mismo tipo exacto.',
            'Ejecuta la implementación de Persona por el tipo declarado de p.',
            'Ejecuta la implementación de Ejecutivo por el tipo real del objeto.',
            'El resultado depende de que trabajar() sea un método estático.',
          ],
          correctIndex: 2,
          explain: 'La llamada es válida porque trabajar() pertenece a la interfaz pública de Persona, pero el dynamic binding selecciona en ejecución la versión sobreescrita de Ejecutivo.',
        },
        {
          kind: 'mc',
          q: 'Un Vendedor conoce varias Sucursales y cada Sucursal conoce varios Vendedores. ¿Qué cardinalidad describe el modelo?',
          options: [
            'Uno a uno.',
            'Uno a muchos.',
            'Muchos a uno.',
          ...
          correctIndex: 3,
          explain: 'Ambos extremos pueden relacionarse con varias instancias del otro: cada vendedor tiene varias sucursales y cada sucursal varios vendedores. Es muchos a muchos.',
        },
        {
          kind: 'open',
          q: 'Analizá las líneas Ejecutivo e = new Ejecutivo(); Persona p = e; Ejecutivo e2 = (Ejecutivo) p;. Indicá cuáles son upcasting o downcasting, si compilan y por qué el último cast es seguro en este caso.',
          model: 'Se espera: la primera línea crea un Ejecutivo. Persona p = e es upcasting implícito y compila porque Ejecutivo ES-UN Persona. Ejecutivo e2 = (Ejecutivo) p es downcasting explícito; compila y es seguro porque p sigue apuntando al objeto real Ejecutivo creado al inicio. En un caso general conviene comprobar p instanceof Ejecutivo antes del cast; el cast no transforma el objeto.',
        },
        {
          kind: 'tf',
          q: 'Agregar una operación vacía a varias subclases para neutralizar un comportamiento heredado es una señal de que la jerarquía asignó responsabilidades incorrectas.',
          a: true,
          explain: 'Si una clase hereda una operación que no debería tener, dejarla vacía no corrige el modelo y duplica código. Conviene separar el comportamiento y asignarlo solo donde corresponde.',
        },
        {
          kind: 'mc',
          q: '¿Cuál de estas afirmaciones diferencia correctamente una interfaz de una clase abstracta dentro del alcance de la materia?',
          options: [
            'La interfaz se instancia directamente y la clase abstracta no.',
            'La clase abstracta puede compartir estado y código; la interfaz expresa comportamiento puro.',
            'La interfaz permite heredar atributos privados de varias clases.',
            'La clase abstracta garantiza herencia múltiple de implementaciones.',
          ],
          correctIndex: 1,
          explain: 'La clase abstracta puede tener atributos, constructores y métodos concretos reutilizables. La interfaz define un contrato de comportamiento y permite combinar capacidades sin herencia múltiple de clases.',
        },
        {
          kind: 'mc',
          q: '¿Qué combinación asocia correctamente cada concepto con su función?',
          options: [
            'Classpath: libera memoria; HEAP: busca clases; STACK: guarda documentación.',
            'Classpath: busca clases; HEAP: aloja objetos; STACK: administra llamadas.',
            'Classpath: ejecuta bytecode; HEAP: compila; STACK: empaqueta archivos.',
            'Classpath: aloja objetos; HEAP: administra llamadas; STACK: busca clases.',
          ],
          correctIndex: 1,
          explain: 'El classpath indica dónde buscar clases, el HEAP aloja objetos creados durante la ejecución y el STACK contiene la pila de llamadas, con argumentos y retornos.',
        },
        {
          kind: 'open',
          q: 'Diseñá un modelo de pedidos donde un Pedido contiene ítems que no existen fuera de él, pero referencia un Cliente que sí existe independientemente. Clasificá ambas relaciones y proponé una direccionalidad razonable.',
          model: 'Se espera: Pedido–ItemPedido es composición si los ítems nacen y desaparecen con el pedido; Pedido crea o controla esas partes. Pedido–Cliente es agregación porque el cliente existe antes y después de un pedido y puede vincularse con muchos. Una solución razonable navega desde Pedido hacia sus ítems y su cliente; puede hacerse bidireccional con Cliente solo si el negocio necesita consultar desde el cliente todos sus pedidos.',
        },
        {
          kind: 'mc',
          q: '¿Cuál de estas decisiones aplica de forma directa composición por sobre herencia?',
          options: [
            'Crear una subclase nueva por cada combinación posible de vuelo y ataque.',
            'Mover todos los comportamientos a una única superclase concreta.',
            'Guardar objetos FormaDeVolar y FormaDeAtacar y delegarles las acciones.',
            'Usar condicionales instanceof cada vez que se ejecuta una acción.',
          ],
          correctIndex: 2,
          explain: 'Delegar en colaboradores intercambiables compone comportamientos y evita una explosión de subclases. Las interfaces mantienen al cliente desacoplado de cada implementación.',
        },
        {
          kind: 'open',
          q: 'Proponé una solución completa para un Robot que muestra y defiende siempre igual, pero puede variar vuelo y ataque durante la ejecución. Incluí contratos, colaboradores, delegación, construcción y un cambio de comportamiento en runtime.',
          model: 'Se espera: Robot conserva mostrarse() y defender() como comportamiento estable. Define referencias FormaDeVolar y FormaDeAtacar, recibidas por constructor o setters, y ejecutarVuelo()/ejecutarAtaque() delegan en esos objetos. Implementaciones como NoVuela, VueloConPropulsion, AtaqueConRayos y AtaqueConMisiles cumplen los contratos. Crear un Robot con una combinación y luego llamar setFormaDeAtacar(new AtaqueConMisiles()) demuestra el cambio en runtime sin recrearlo ni alterar la jerarquía.',
        },
      ],
    },
  ],
